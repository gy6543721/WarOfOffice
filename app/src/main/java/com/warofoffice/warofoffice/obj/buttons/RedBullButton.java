...
public class RedBullButton extends WorldObj implements OnTouchObject {

    public interface RedBullSkill{
        public void useRedBullSkill();
    }

    private RedBullSkill redBullSkill;

    public static boolean redbullSkillOn;
    ...
    public RedBullButton(Context context, int x, int y, int interval, RedBullSkill redBullSkill) {
        ...
        this.redbullSkillOn = false;
        this.redBullSkill = redBullSkill;
        ...
        skillBitmap = bm.getBitmap(R.drawable.redbull_logo_big, bitmapWidth, bitmapHeight);
    ...
    public void touchEvent() {
        ...
        if (currentBitmapPosition == 5 && Money.moneyNumber >= interval*5) {
            ...
            this.redbullSkillOn = true;
            Money.moneyNumber -= interval*5;
            redBullSkill.useRedBullSkill();
