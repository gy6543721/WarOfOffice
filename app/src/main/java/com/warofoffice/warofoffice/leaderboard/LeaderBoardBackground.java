...
public class LeaderBoardBackground extends LeaderBoardObj {
    ...
    public LeaderBoardBackground(Context context, int x, int y, int speed){
        super(context);
        ...
        backgroundBitmap = bm.getBitmap(R.drawable.leaderboard_background, bitmapWidth, bitmapHeight);
        width = bitmapWidth;
        height = bitmapHeight;
